  ...
  */
  function step(timestamp) {
    ...
    scrollnimates.forEach( function ( sn ) {
      ...
      if ( scrollPoint > ( sn.animationOffset - halfWindowHeight * 2 ) && scrollPoint < (400) ) {  //Test this on other viewports
...
// Parallax function 1 (modified stop point)
(function() {
...
var scrollnimates = [].slice.call(document.getElementsByClassName('scrollnimate3'));
// get their offset from top of screen and their scroll speed
scrollnimates.forEach( function ( sn ) {
    var clientOffsets = sn.getBoundingClientRect();
    sn.animationOffset = clientOffsets.top + scrollPosition;
